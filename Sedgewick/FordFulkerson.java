...
public class FordFulkerson {
    ...
    private int sSideSize;
    private List<Integer> sCut;
    private int dSideSize;
    private List<Integer> dCut;
    ...
    public FordFulkerson(FlowNetwork G, int s, int t) {
        ...
        sCut = new ArrayList<>();
        dCut = new ArrayList<>();
        for(int si=0; si<marked.length; ++si)
            if(marked[si] == true) {
                sSideSize++;
                sCut.add(si);
            }else{
    ...
    public int getSSideSize() {
        return sSideSize;
    }
    
    public int getDSideSize() {
        return dSideSize;
    }
